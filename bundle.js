...
function TopBar({ role, phase, currentTurn, attacksLeft, scores, bingoLines, lang, setLang, onExit, gameOver = false }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "stretch", gap: 10, paddingTop: 6, paddingBottom: 12, width: "100%", boxSizing: "border-box", overflow: "hidden", opacity: gameOver ? 0.28 : 1, pointerEvents: gameOver ? "none" : "auto", transition: "opacity 400ms ease" } }, /* @__PURE__ */ React.createElement("div", { style: { position: "relative", display: "flex", alignItems: "center", justifyContent: "center", width: "100%", boxSizing: "border-box", padding: "0 10px", height: 40, marginBottom: 5 } }, /* @__PURE__ */ React.createElement("div", { style: {
    position: "absolute",
    left: 10,
    top: "50%",
    transform: "translateY(-50%)"
  } }, /* @__PURE__ */ React.createElement(LangToggle, { lang, setLang })), /* @__PURE__ */ React.createElement("div", { style: { width: 34, height: 34 } }, /* @__PURE__ */ React.createElement("img", { src: "assets/logo_vector.svg", style: { width: "100%", height: "100%", filter: `drop-shadow(0 0 10px ${turnPal.glow}0.5))` }, alt: "" })), /* @__PURE__ */ React.createElement("div", { style: {
    position: "absolute",
    right: 10,
    top: "50%",
    transform: "translateY(-50%)"
  } }, /* @__PURE__ */ React.createElement(ExitToggle, { onExit, lang }))), /* @__PURE__ */ React.createElement("div", { style: {
    display: "flex",
    alignItems: "center",
...
function SwipeFrame({ title, children, tweaks, setTweak, bursts, phase, role, modal, onCloseModal, onResolveModal, lang, setLang, onExit, currentTurn, attacksLeft, scores, allScores, bingoLines, minigame, setMinigame, resolveMinigame, sharedMinigame, onMinigameWin, sharedRound, history, celebration, onCelebrationDone }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: frameRef, style: {
    ...
    fontFamily: "'EliceDigitalBaeum', system-ui, sans-serif"
  } }, /* @__PURE__ */ React.createElement(AmbientBokeh, { role }), /* @__PURE__ */ React.createElement("div", { style: { height: 44, display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0 28px", fontSize: 14, fontWeight: 700, color: "white", zIndex: 60, position: "relative" } }, /* @__PURE__ */ React.createElement("span", null, "9:41"), /* @__PURE__ */ React.createElement("div", { style: { width: 16, height: 10, border: "1px solid rgba(255,255,255,0.5)", borderRadius: 2, position: "relative" } }, /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 1, background: "white", borderRadius: 1 } }))), /* @__PURE__ */ React.createElement("div", { "data-ticker-header": "true", style: { position: "relative", zIndex: 60 } }, /* @__PURE__ */ React.createElement(
    TopBar,
    {
      role,
      phase,
...
function DemoApp() {
  ...
  if (isMobile) {
    ...
    return /* @__PURE__ */ React.createElement("div", { id: "stage", className: "m" }, /* @__PURE__ */ React.createElement("div", { className: "mTopHud" }, hud, /* @__PURE__ */ React.createElement("div", { className: "swipeHint" }, /* @__PURE__ */ React.createElement("span", { className: "sw" }, "\u21C4"), " ", swipe)), /* @__PURE__ */ React.createElement("div", { className: "mCarousel", ref: carRef }, /* @__PURE__ */ React.createElement("div", { className: "mCard" + (activeRole && activeRole !== "guest" ? " inactive" : "") }, /* @__PURE__ */ React.createElement("div", { className: "boardlabel", style: { color: "#B487FD" } }, "\uCE5C\uAD6C (\uBD07) \xB7 GUEST"), /* @__PURE__ */ React.createElement("div", { className: "bz" }, /* @__PURE__ */ React.createElement(VariantJelly, { role: "guest", ...common }))), /* @__PURE__ */ React.createElement("div", { className: "mCard" + (activeRole && activeRole !== "host" ? " inactive" : "") }, /* @__PURE__ */ React.createElement("div", { className: "boardlabel", style: { color: "#FF5CA1" } }, "YOU \xB7 HOST"), /* @__PURE__ */ React.createElement("div", { className: "bz" }, /* @__PURE__ */ React.createElement(VariantJelly, { role: "host", ...common })))), /* @__PURE__ */ React.createElement("div", { className: "mDots" }, /* @__PURE__ */ React.createElement("span", { className: activeRole === "guest" ? "on" : "" }), /* @__PURE__ */ React.createElement("span", { className: activeRole === "host" ? "on" : "" })));
  }
