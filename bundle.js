...
function DemoApp() {
  ...
  if (isMobile) {
    ...
    return /* @__PURE__ */ React.createElement("div", { id: "stage", className: "m" }, /* @__PURE__ */ React.createElement("div", { className: "mTopHud" }, /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: 0, right: 0 } }, /* @__PURE__ */ React.createElement(LangToggle, { lang, setLang })), hud, /* @__PURE__ */ React.createElement("div", { className: "swipeHint" }, /* @__PURE__ */ React.createElement("span", { className: "sw" }, "\u21C4"), " ", swipe)), /* @__PURE__ */ React.createElement("div", { className: "mCarousel", ref: carRef }, /* @__PURE__ */ React.createElement("div", { className: "mCard" + (activeRole && activeRole !== "guest" ? " inactive" : "") }, /* @__PURE__ */ React.createElement("div", { className: "bz" }, /* @__PURE__ */ React.createElement(VariantJelly, { role: "guest", ...common }))), /* @__PURE__ */ React.createElement("div", { className: "mCard" + (activeRole && activeRole !== "host" ? " inactive" : "") }, /* @__PURE__ */ React.createElement("div", { className: "bz" }, /* @__PURE__ */ React.createElement(VariantJelly, { role: "host", ...common })))), /* @__PURE__ */ React.createElement("div", { className: "mDots" }, /* @__PURE__ */ React.createElement("span", { className: activeRole === "guest" ? "on" : "" }), /* @__PURE__ */ React.createElement("span", { className: activeRole === "host" ? "on" : "" })));
  }
